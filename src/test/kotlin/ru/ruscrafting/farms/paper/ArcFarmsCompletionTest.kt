...
class ArcFarmsCompletionTest : FunSpec({
    test("completion preserves argument routing order permissions and case insensitive prefixes") {
        ...
        val cases = listOf(
            ...
            listOf("admin", "expeditions", "f") to listOf("factory"),
            listOf("admin", "expeditions", "factory", "") to listOf("OldMine", "help"),
            listOf("admin", "expeditions", "factory", "OldMine", "c") to listOf("crane", "cooling"),
            ...
            listOf("admin", "event", "OldMine", "G") to listOf("gas"),
