...
class MineWorkshopGeometryTest : FunSpec({
    ...
    test("control centers remain at reachable physical panel positions") {
        ...
        feed.y shouldBe (112.55 plusOrMinus 0.00001)
        feed.z shouldBe (20.15 plusOrMinus 0.00001)
        drive.x shouldBe (41.95 plusOrMinus 0.00001)
        drive.y shouldBe (112.45 plusOrMinus 0.00001)
        drive.z shouldBe (19.55 plusOrMinus 0.00001)
        feed.z shouldNotBe drive.z
        MineWorkshopGeometry.captionLocation(drive).y shouldBe (113.5 plusOrMinus .00001)
    }
    ...
    test("pour stages hand the billet from the casting path to the rack") {
        ...
        pourEnd.distance(coolingStart) shouldBe 0f
        MineWorkshopGeometry.CASTING_TO_RACK.last().z shouldBe 3.85f
