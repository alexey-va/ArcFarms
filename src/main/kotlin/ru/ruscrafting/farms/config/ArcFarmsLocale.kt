...
enum class MessageKey(val path: String) {
    ...
    FARM_HELL_PLANTATION_COLD("farm.hell-greenhouse.plot-cold"),
    FARM_HELL_PLANTATION_GROWING("farm.hell-greenhouse.plot-growing"),
    FARM_HELL_PLANTATION_HOT("farm.hell-greenhouse.plot-hot"),
    FARM_HELL_PLANTATION_COOLING("farm.hell-greenhouse.plot-cooling"),
    FARM_HELL_PLANTATION_READY("farm.hell-greenhouse.plot-ready"),
    FARM_HELL_PLANTATION_OPEN("farm.hell-greenhouse.valve-open"),
    FARM_HELL_PLANTATION_CLOSE("farm.hell-greenhouse.valve-close"),
    FARM_HELL_PLANTATION_VALVE("farm.hell-greenhouse.valve-label"),
    FARM_HELL_PLANTATION_SCORCHED("farm.hell-greenhouse.scorched"),
    FARM_HELL_PLANTATION_GUIDE("farm.hell-greenhouse.guide"),
...
class ArcFarmsLocale(
    ...
    companion object {
        ...
        private val EXPECTED_PLACEHOLDERS = mapOf(
            ...
            "farm.hell-greenhouse.plot-growing" to setOf("point", "time"),
            "farm.hell-greenhouse.plot-hot" to setOf("point", "time"),
            "farm.hell-greenhouse.plot-cooling" to setOf("point", "time"),
            "farm.hell-greenhouse.plot-ready" to setOf("point"),
            "farm.hell-greenhouse.valve-label" to setOf("point"),
            "farm.hell-greenhouse.scorched" to setOf("point"),
