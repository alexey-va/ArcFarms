...
| `domain/FarmTerminalDelivery`, `farm.incident.route/FarmFoodDeliveryIncident`, `FarmFoodDeliverySession` | fixed crate-to-route finale, mounted/walking participant identity, rifle/HUD/time/damage lifecycle | dismount, ambush, restart, unavailable route and final cleanup |
